...
from dragonsr.Config import Dragon as _CfgDragon, Loss as _CfgLoss
from dragonsr.dataprocessing.Denoise import MCDropoutWeighter, SamplingContext
from dragonsr.dataprocessing.Features import CombinationBuilder
from dragonsr.helpers.Helper import _extract_best_formula_from_log
...
class DragonOrchestrator:
	...
	def setup_searcher(method_cfg, X_sel, y, feature_names, feat_scores, log_path, seed, device):
		...
		from dragonsr.runner.Dragon import DragonSearcher, RegressionDataset
		from dragonsr.searchspace.SearchSpace import SearchSpaceBuilder
