...
from dragonsr.Config import PySR as _CfgPySR, Paths as _CfgPaths, Experiment as _CfgExp
from dragonsr.dataprocessing.Data import DatasetLoader
from dragonsr.helpers.stats import (
...
def run_pysr(
    ...
    try:
        ...
        denoise_info = None
        if add_noise:
            from dragonsr.dataprocessing.Denoise import GPRDenoiser
