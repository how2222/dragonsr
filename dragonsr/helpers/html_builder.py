...
from dragonsr.Config import Dragon as _CfgDragon, PySR as _CfgPySR, Experiment as _CfgExp
from dragonsr.helpers.stats import _make_formula_stats_svg
...
{JS}
    ...
    from dragonsr.Config import Paths as _CfgPaths
    out = Path(_CfgPaths.OUTPUT_DIR) / "leaderboard_standalone.html"
